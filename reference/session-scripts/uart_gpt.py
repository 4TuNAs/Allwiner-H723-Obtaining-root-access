...
try:
    # Не дёргать reset-линии USB-UART адаптера.
    try:
        ser.dtr = False
        ser.rts = False
    except Exception:
    ...
    if len(data) != EXPECTED:
        ...
        raise RuntimeError(
            "Dump length mismatch - not accepting it"
        )
